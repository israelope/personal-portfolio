...
export const MobileMenu = ({menuOpen, setMenuOpen}) => {
    ...
    return (
        ...
        `}>
            ...
            className={`text-2xl font-semibold text-white my-4 transition-transfor duration-300
                ${menuOpen
                ...
                `}>
                    ...
                    <a href="#projects" 
                    onClick={() => setMenuOpen(false)} className={`text-2xl font-semibold text-white my-4 transition-transfor duration-300
                        ${menuOpen
                             ? "opacity-100 translate-y-0"
                             : "opacity-0 translate-y-5"
                            }
